...
CREATE MASTER KEY ENCRYPTION BY PASSWORD = 'sRkp@2022#';

-- Here we are using the Shared Access Signature to authorize the use of the Azure Data Lake Storage account

CREATE DATABASE SCOPED CREDENTIAL SasToken
WITH IDENTITY='SHARED ACCESS SIGNATURE'
, SECRET = '?sv=2021-06-08&ss=bfqt&srt=sco&sp=rwdlacupyx&se=2023-02-08T16:08:16Z&st=2023-02-08T08:08:16Z&spr=https&sig=pvWKjqgmJyH7VqA9AjK8l1Jpxo7biamz1Nx7EV5vTPU%3D';
...
CREATE EXTERNAL FILE FORMAT Text4FileFormat WITH (  
...
CREATE EXTERNAL TABLE [log4data]
(
    [Id] [int],
